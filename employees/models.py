...
class Salary(models.Model):
    ...
    salary_proportion = models.DecimalField(max_digits=3, decimal_places=2, verbose_name='工资比例',help_text='工资比例在0.8~1.10之间')
...
class DailyReport(models.Model):
    ...
    assess = tinymce.models.HTMLField(blank=True, null=True,verbose_name='评价内容')
    score = models.IntegerField(choices=SCORE_CHOICES,blank=True, null=True, verbose_name='评价等级')
